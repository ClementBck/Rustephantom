...
public class EnnemyMovementDungeon : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.tag == "pottery")
        {
            lookPosition = new Vector3(pottery.transform.position.x, transform.position.y, pottery.transform.position.z);
            transform.LookAt(lookPosition);
            isActive = false;
            Invoke("ResetChoice", 5f);
        }
