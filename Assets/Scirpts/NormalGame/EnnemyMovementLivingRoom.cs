...
public class EnnemyMovementLivingRoom : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            lookPosition = new Vector3(chest2.transform.position.x, transform.position.y, chest2.transform.position.z);
        ...
        if (other.gameObject.tag == "long drawers")
        {
            lookPosition = new Vector3(longDrawers.transform.position.x, transform.position.y, longDrawers.transform.position.z);
            transform.LookAt(lookPosition);
            isActive = false;
            Invoke("ResetChoice", 5f);
        }
